...
interface AuthContextType {
  ...
  loading: boolean;
  userRole: string | null;
  fetchUserInfo: () => Promise<AuthUser | null>;  // ✅ Thêm vào interface
  setUser: (user: AuthUser | null) => void;       // ✅ Thêm vào interface
}
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <AuthContext.Provider value={{ 
      ...
      loading, 
      userRole,
      fetchUserInfo,   // ✅ Export function
      setUser          // ✅ Export function
    }}>
      {children}
    </AuthContext.Provider>
  );
